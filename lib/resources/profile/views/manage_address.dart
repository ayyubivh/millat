...
class _ManageAddressState extends State<ManageAddress> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Manage Address',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700)),
        centerTitle: false,
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text('California 4908',style: TextStyle(fontWeight: FontWeight.w700,color: black122),),
