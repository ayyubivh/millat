                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TravelTextformField(
                          ...
                          icon: ImageIcon(
                            const AssetImage(AppAssetsStrings.personalInfo),
                        ...
                        TravelTextformField(
                          ...
                          icon: ImageIcon(
                            const AssetImage(AppAssetsStrings.travelEmail),
                            color: ColorManager.lightGreyA3,
                          ),
                            ...
                            builder: (context, state) {
                              return Row(
                                children: [
                                  kWidth15,
                                  ImageIcon(
                                    const AssetImage(AppAssetsStrings.guests),
                                    color: ColorManager.lightGreyA3,
                                  ),
                                  kWidth15,
                                  _guestAddwidget(
                          ...
                          builder: (context, state) => Container(
                            ...
                            child: state.formImages.isNotEmpty
                                ...
                                : GestureDetector(
                                    onTap: () {
                                      BlocProvider.of<TravelBloc>(context)
                                          .add(const PickMultipleImageEvent());
                                    },
                                    child: Column(
                                      mainAxisAlignment:
