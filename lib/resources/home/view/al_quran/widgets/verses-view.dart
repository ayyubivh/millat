...
import 'package:millat/resources/home/view/al_quran/widgets/verses_card_widget.dart';
          ...
          child: type == Qurantype.sura
              ? BlocBuilder<QuranBloc, QuranState>(
                  builder: (context, state) {
                    ...
                    return state.chapterVersesModel?.data.ayahs == null
                        ? const Loader()
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return VersesCardWidget(
                                bookMarkOntap: () {
                                  print('${chapterid!}:${index + 1}');
                                  print(
                                      "here list items ${context.read<BookmarkBloc>().state.dbCollectionItems}");
                                  ...
                                  //   builder: (context) =>
                                  //       VersesView(type: Qurantype.verse),
                                  // ));
                                  context.read<QuranBloc>().add(
                                          FetchVersesByKey(verseKey: [
                                        '$chapterid:${index + 1}'
                                      ]));
                                },
                                playOntap: () {
                                  context.read<QuranBloc>().add(
                                      PlayAllChapterAudiosAuto(index: index));
                                },
              ...
              : type == Qurantype.para
                  ? BlocBuilder<QuranBloc, QuranState>(
                      builder: (context, state) {
                        // if (state.isLoading ||
                        //     state.paraVersesModel?.verses == null ||
                        //     state.paraVersesModelofUthmani?.verses == null) {
                        //   return const Loader();
                        // }
                                    ...
                                    : ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return VersesCardWidget(
                                            ...
                                            shareOnTap: () {
                                              Share.share(
                                                  '${uthmanidata[index].textOfNoSymbol}\n${removeFootnotesFromMeaning(
                                                state.paraTranslationText?[
                                                        index] ??
                                                    '',
                                              )}\n\n${state.chapterVersesModel!.data.englishName}: Ayah${index + 1}');
