...
class ChooseDhikrView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      BlocProvider.of<TasbihBloc>(context).add(const FetchDhikr());
    });
    return Scaffold(
      ...
      body: BlocBuilder<TasbihBloc, TasbihState>(builder: (context, state) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                BlocProvider.of<TasbihBloc>(context).add(SelectDhikerEvent(
                    dikr: data.content!,
