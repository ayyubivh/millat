...
_$_ProductItemsSubCategorySunnahModel
    _$$_ProductItemsSubCategorySunnahModelFromJson(Map<String, dynamic> json) =>
        _$_ProductItemsSubCategorySunnahModel(
...
Map<String, dynamic> _$$_ProductItemsSubCategorySunnahModelToJson(
        _$_ProductItemsSubCategorySunnahModel instance) =>
    <String, dynamic>{
...
_$_CategoryItem _$$_CategoryItemFromJson(Map<String, dynamic> json) =>
    _$_CategoryItem(
      ...
      subCategoryId:
          CategoryInfo.fromJson(json['subCategoryId'] as Map<String, dynamic>),
