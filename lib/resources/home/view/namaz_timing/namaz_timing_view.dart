...
class NamazTimingView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      providers: [
        BlocProvider(
          create: (context) => LocationBloc()..add(FetchCities()),
        ),
        BlocProvider(
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          BlocBuilder<
                                                                            ...
                                                                            builder:
                                                                                (context, state) {
                                                                              final namazMethodName = state.namazMethodName;
                                                                              final halfLength = (namazMethodName.length / 2).ceil();
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          BlocBuilder<
                                                                            ...
                                                                            builder: (context, state) =>
                                                                                Text(
                                                                              state.school == 1 ? "Hanafi" : "Standard(Shafi, Malik, Hambali)",
                                                                              style: const TextStyle(
                                                                                fontWeight: FontWeight.w400,
                                                                                fontSize: 12,
                                                                              ),
