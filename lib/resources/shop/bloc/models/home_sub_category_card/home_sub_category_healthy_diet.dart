...
part 'home_sub_category_healthy_diet.freezed.dart';
part 'home_sub_category_healthy_diet.g.dart';

@freezed
class ShopHomeBackgroundCardHealthyDietModel
    with _$ShopHomeBackgroundCardHealthyDietModel {
  const factory ShopHomeBackgroundCardHealthyDietModel({
    required int status,
    required String message,
    required String error,
    required Result result,
  }) = _ShopHomeBackgroundCardHealthyDietModel;

  factory ShopHomeBackgroundCardHealthyDietModel.fromJson(
          Map<String, dynamic> json) =>
      _$ShopHomeBackgroundCardHealthyDietModelFromJson(json);
}
