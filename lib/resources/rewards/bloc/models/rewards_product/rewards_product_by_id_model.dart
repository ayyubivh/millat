...
part 'rewards_product_by_id_model.g.dart';
part 'rewards_product_by_id_model.freezed.dart';

@freezed
class RewardsProductByIdModel with _$RewardsProductByIdModel {
  const factory RewardsProductByIdModel({
    @JsonKey(name: 'status') required int? status,
    @JsonKey(name: 'message') required String? message,
    @JsonKey(name: 'error') required String? error,
    @JsonKey(name: 'result') required Result? result,
  }) = _RewardsProductByIdModel;

  factory RewardsProductByIdModel.fromJson(Map<String, dynamic> json) =>
      _$RewardsProductByIdModelFromJson(json);
}
