...
part 'products_item_women_model.g.dart';
part 'products_item_women_model.freezed.dart';

@freezed
class ProductItemsSubCategoryWomenModel
    with _$ProductItemsSubCategoryWomenModel {
  const factory ProductItemsSubCategoryWomenModel({
    required int? status,
    required String? message,
    required String? error,
    required Result? result,
  }) = _ProductItemsSubCategoryWomenModel;

  factory ProductItemsSubCategoryWomenModel.fromJson(
          Map<String, dynamic> json) =>
      _$ProductItemsSubCategoryWomenModelFromJson(json);
}
