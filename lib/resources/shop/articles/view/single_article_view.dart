  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: false,
        title: Text('Single Aricles',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700)),
        actions: [
          Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Bilal • 20 Jan 2022',style: TextStyle(color: green77,fontSize: 16,fontWeight: FontWeight.bold),),
              ...
              SizedBox(height: 20,),
              Text('Bilal Cotton Galabiyya',style: TextStyle(color: black16,fontSize: 20,fontWeight: FontWeight.w600),),

              SizedBox(height: 20,),
              Text('How do you create compelling clothes that wow your friends and impress your managers?Lorem ipsum dolor sit amet, consectetur adipiscing elit. At imperdiet et pellentesque euismod. Nunc sed risus sed cursus nunc vel posuere. Et suspendisse at et, scelerisque risus, amet tincidunt pretium condimentum. Ultricies neque tristique purus posuere venenatis mattis leo imperdiet.Eget turpis quam nulla pharetra eu enim enim. Eget nullam elementum nec pharetra in volutpat quam. Tellus egestas mauris congue elit erat feugiat turpis. Turpis in integer lectus dictum scelerisque amet. Nam lectus dis tristique tristique eros, nisl, urna. Tortor tortor massa, leo, tincidunt augue. Sit elit nequeurpis in integer lectus dictum scelerisque amet. Nam lectus dis tristique tristique eros, nisl, urna. Tortor tortor massa, leo, tincidunt augue. Sit elit neque',style: TextStyle(color: black122,fontSize: 17,height: 1.3),),
              SizedBox(height: 20,),
        ...
        child: Row(
          children: [
            Padding(
              ...
              child: ClipRRect(borderRadius: BorderRadius.circular(10),child: Image.asset('assets/dummy/article.png')),
            ),
            SizedBox(width: 10,),
            Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Bilal Cotton Galabiyya',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w600),),
                SizedBox(height: 5,),
                Text('₹ 1,523.68',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w600),),
