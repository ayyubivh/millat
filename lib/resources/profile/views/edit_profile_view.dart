...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  @override
  void initState() {
    BlocProvider.of<DatabaseBloc>(context).add(FetchAuthUser(context: context));
    ...
    return Scaffold(
        ...
        body: BlocConsumer<DatabaseBloc, DatabaseState>(
          listener: (context, state) {
            if (!state.isLoading) {
              addField(state.authUserModel?.result?.user);
            }
          },
                                ...
                                Positioned(
                                  ...
                                  child: Stack(
                                    children: [
                                      Align(
                                        alignment: Alignment.center,
                                        child: BlocBuilder<DatabaseBloc,
                                            DatabaseState>(
                                          builder: (context, state) {
                                            return CircleAvatar(
                                              radius: 45,
